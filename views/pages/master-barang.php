<section class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <h1 class="text-3xl font-bold text-ink sm:text-4xl">Master Barang</h1>
            <p class="mt-4 max-w-2xl leading-7 text-stone-600">
                Data ini diambil dari hasil analisa invoice Januari 2026 dan sudah digabung berdasarkan nama barang serta ukuran.
            </p>
        </div>
